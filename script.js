(function () {
  ...
  function buildLetterText() {
    ...
    const nivel = sanitize(fields.nivel.value) || '______';
    ...
    return [
      ...
      `Mediante la presente, me permito solicitar su autorización para que el/la ${tratamiento} ${solicitante}, portador(a) de la cédula de ciudadanía No. ${cedula}, estudiante de ${nivel} nivel de la carrera de Ingeniería en Alimentos, realice sus prácticas preprofesionales en su prestigiosa institución.`,
  ...
  async function handleSubmit(event) {
    ...
    try {
      setStatus('Enviando correo...', 'info');
      toggleButtons(true);
      ...
      const params = {
        ...
        nivel: sanitize(fields.nivel.value),
